			...
			l++;
			   ...
			   var markersEsp =[];
				...
				var MaisonIcon = L.icon({
					    iconUrl:'leaflet/images/houses.png',
				   ...
				   for (var z=0; z<nomsMa.length; z++) {    
				    var marker= new L.marker([altitudesMa[z],longitudesMa[z]], {icon:MaisonIcon}).addTo(mymap);
				 ...
				 for (var  y=0; y < markersMa.length; y++) {
			        ...
			        var SiteIcon = L.icon({
					    iconUrl:'leaflet/images/site.png',
				    ...
				    var marker= new L.marker([altitudesSites[b],longitudesSites[b]], {icon:SiteIcon}).addTo(mymap);
			       ...
			       for ( var c=0; c < markersSites.length; c++) {
                     ...
                     /*********Mouments**********/
					    ...
					    iconUrl:'leaflet/images/monument.png',
					   ...
					   // iconAnchor:   [22, 94], // point of the icon which will correspond to marker's location
					    ...
					    var marker= new L.marker([altitudesMo[d],longitudesMo[d]], {icon:MonumentIcon}).addTo(mymap);
				   ...
				   /*********Espaces**********/
				   var EspaceIcon = L.icon({
					    iconUrl:'leaflet/images/espace.png',
				      ...
				      for (var f=0; f<nomsEsp.length; f++) {    
					    var marker= new L.marker([altitudesEsp[f],longitudesEsp[f]], {icon:EspaceIcon}).addTo(mymap);
