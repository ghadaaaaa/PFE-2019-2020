 ...
 <br>
       ...
       <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded p-5">
              ...
              <span class="section-heading-lower">Appelations traditionnelles </span>
         </h2>
         <h2 class="section-heading mb-4">     
                <span class="section-heading-upper">Definition</span>
              </h2>
             ...
             <h2 class="section-heading mb-4">
	              ...
	              <ul>
	              <li><p>patati patata</p></li>
	              </ul>
	              </c:forEach>
	              <p class="mb-0"></p>
             <h2 class="section-heading mb-4">
	                <span class="section-heading-upper">Fonctions architecturales</span>
	              </h2>
	              ...
	              <p class="mb-0"></p>
              <h2 class="section-heading mb-4">
	                <span class="section-heading-upper">Fonctions sociales</span>
	              </h2>
              ...
              <h2 class="section-heading mb-4">
                ...
                <span class="section-heading-upper">Fonctions environementales</span>
              </h2>
              <p>
              ...
              <h2 class="section-heading mb-4">
				...
				<div id="demo" class="carousel slide" data-ride="carousel" style="padding-right: 0px;padding-top: 0px;padding-bottom: 0px;width: 400;padding-left: 260px;">
                   ...
                   <c:forEach var="image" items="${mai.images}">
					...
					<h2 class="section-heading mb-4">
	                <span class="section-heading-upper">Sources</span>
	              </h2>
