      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item px-lg-4">
           ...
           <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="Regions">Les wilayas</a>
          </li>
           <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="Contact">Contact</a>
          </li>
            <li class="nav-item px-lg-4">
            <a href="Deconnexion?id_compte_archi=0"  class="btn btn-primary btn-xl"  role="button" 
               onclick="return confirm('Etes vous sùr de vouloir se déconnecter de votre compte?');">Déconnexion</a>
            </li>
